...
/**
 * @title GemBotsNFAv3 — BAP-578 Compliant Non-Fungible Agents
 ...
 */
contract GemBotsNFAv3 is ERC721, ERC721URIStorage, Ownable, ReentrancyGuard, Pausable, IBAP578 {
    ...
    /// @notice Mint fee in BNB (0.1 BNB default)
    ...
    /**
     * @notice Mint a new NFA with paid fee + full metadata.
